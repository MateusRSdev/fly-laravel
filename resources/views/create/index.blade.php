    ...
    <div class="m-5">
                ...
                <div class="row p-3">
                    <div class="col-6 m-auto">
                        ...
                        <div class=" text-light p-1 inputsConfig rounded" id="originCase">
                            <input id="inputOrigin" type="text" class="form-control my-2" name="origem_1">
                        </div>
        ...
        <div id="templates" class="d-none">
            ...
            <div id="template" class="inputConfig row">
                <div class="col-4">
                    <input class="form-control" type="text" name="RfieldName">

                </div>
                <div class="col-8 d-flex">


                    <select class="form-control" name="RfieldType" id="">
                    ...
                    <input type="checkbox" name="Rrequired" value="required">
                    <input type="number" name="R:min">
                    <input type="number" name="R:max">
